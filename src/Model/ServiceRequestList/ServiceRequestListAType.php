...
namespace IofXmlPhp\Model\ServiceRequestList;
...
class ServiceRequestListAType extends BaseMessageElementType
{
     ...
     *
     * @var \IofXmlPhp\Model\OrganisationServiceRequestType[] $organisationServiceRequest
     */
     ...
     *
     * @return self
     * @param \IofXmlPhp\Model\OrganisationServiceRequestType $organisationServiceRequest
     */
    public function addToOrganisationServiceRequest(\IofXmlPhp\Model\OrganisationServiceRequestType $organisationServiceRequest)
    {
     ...
     * Service requests made by organisations.
     *
     * @return \IofXmlPhp\Model\OrganisationServiceRequestType[]
     */
