...
class FeeType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\AmountType $amount
     */
    private $amount = null;
     ...
     *
     * @var \Petrocki\IofXmlPhp\AmountType $taxableAmount
     */
     ...
     * The fee amount, optionally including currency code. This element must not be present if a Percentage element exists.
     *
     * @param \Petrocki\IofXmlPhp\AmountType $amount
     * @return self
     */
    public function setAmount(?\Petrocki\IofXmlPhp\AmountType $amount = null)
    {
        $this->amount = $amount;
        return $this;
    }
     ...
     * The fee amount that is taxable, i.e. considered when calculating taxes for an event. This element must not be present if a Percentage element exists, or if an Amount element does not exist.
     *
     * @param \Petrocki\IofXmlPhp\AmountType $taxableAmount
     * @return self
     */
    public function setTaxableAmount(?\Petrocki\IofXmlPhp\AmountType $taxableAmount = null)
    {
