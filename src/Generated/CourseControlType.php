...
class CourseControlType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\MapPositionType $mapTextPosition
     */
     ...
     * Indicates the position of the center of the text relative to the center of the control circle.
     *
     * @param \Petrocki\IofXmlPhp\MapPositionType $mapTextPosition
     * @return self
     */
    public function setMapTextPosition(?\Petrocki\IofXmlPhp\MapPositionType $mapTextPosition = null)
    {
