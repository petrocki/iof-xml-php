...
namespace Petrocki\IofXmlPhp\CourseData;
...
class CourseDataAType extends BaseMessageElementType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\RaceCourseDataType[] $raceCourseData
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\RaceCourseDataType $raceCourseData
     */
    public function addToRaceCourseData(\Petrocki\IofXmlPhp\RaceCourseDataType $raceCourseData)
    {
     ...
     * The course data for each race; one element per race in the event.
     *
     * @return \Petrocki\IofXmlPhp\RaceCourseDataType[]
     */
