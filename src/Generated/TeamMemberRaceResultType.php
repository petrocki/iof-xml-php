...
class TeamMemberRaceResultType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\TeamMemberRaceResultType\TimeBehindAType[] $timeBehind
     */
    private $timeBehind = [
     ...
     *
     * @var \Petrocki\IofXmlPhp\TeamMemberRaceResultType\PositionAType[] $position
     */
    private $position = [
     ...
     *
     * @var \Petrocki\IofXmlPhp\OverallResultType $overallResult
     */
     ...
     *
     * @var \Petrocki\IofXmlPhp\SplitTimeType[] $splitTime
     */
    private $splitTime = [
     ...
     *
     * @var \Petrocki\IofXmlPhp\ControlAnswerType[] $controlAnswer
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\TeamMemberRaceResultType\TimeBehindAType $timeBehind
     */
    public function addToTimeBehind(\Petrocki\IofXmlPhp\TeamMemberRaceResultType\TimeBehindAType $timeBehind)
    {
     ...
     * The time, in seconds, that the the team member is behind the winner. Fractions of seconds (e.g. 258.7) may be used if the time resolution is higher than one second.
     *
     * @return \Petrocki\IofXmlPhp\TeamMemberRaceResultType\TimeBehindAType[]
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\TeamMemberRaceResultType\PositionAType $position
     */
    public function addToPosition(\Petrocki\IofXmlPhp\TeamMemberRaceResultType\PositionAType $position)
    {
     ...
     * The position in the result list for the person that the result belongs to. This element should only be present when the Status element is set to OK.
     *
     * @return \Petrocki\IofXmlPhp\TeamMemberRaceResultType\PositionAType[]
     */
     ...
     * Holds the result after the current leg for the team.
     *
     * @return \Petrocki\IofXmlPhp\OverallResultType
     */
     ...
     * Holds the result after the current leg for the team.
     *
     * @param \Petrocki\IofXmlPhp\OverallResultType $overallResult
     * @return self
     */
    public function setOverallResult(?\Petrocki\IofXmlPhp\OverallResultType $overallResult = null)
    {
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\SplitTimeType $splitTime
     */
    public function addToSplitTime(\Petrocki\IofXmlPhp\SplitTimeType $splitTime)
    {
     ...
     * Contains the times at each control of the course. Each control of the team member's course has to be defined in a SplitTime element, even if the control has not been punched. Start and finish times must not be present as SplitTime elements.
     *
     * @return \Petrocki\IofXmlPhp\SplitTimeType[]
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\ControlAnswerType $controlAnswer
     */
    public function addToControlAnswer(\Petrocki\IofXmlPhp\ControlAnswerType $controlAnswer)
    {
     ...
     * Defines the answer for a trail-O control.
     *
     * @return \Petrocki\IofXmlPhp\ControlAnswerType[]
     */
