...
class ControlType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\IdType[] $punchingUnitId
     */
     ...
     *
     * @var \Petrocki\IofXmlPhp\MapPositionType $mapPosition
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\IdType $punchingUnitId
     */
    public function addToPunchingUnitId(\Petrocki\IofXmlPhp\IdType $punchingUnitId)
    {
     ...
     * The position of the control according to tha map's coordinate system.
     *
     * @param \Petrocki\IofXmlPhp\MapPositionType $mapPosition
     * @return self
     */
    public function setMapPosition(?\Petrocki\IofXmlPhp\MapPositionType $mapPosition = null)
    {
