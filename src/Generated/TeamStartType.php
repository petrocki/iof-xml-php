...
class TeamStartType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\TeamMemberStartType[] $teamMemberStart
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\TeamMemberStartType $teamMemberStart
     */
    public function addToTeamMemberStart(\Petrocki\IofXmlPhp\TeamMemberStartType $teamMemberStart)
    {
     ...
     * Information about the start times for the team members. One element per relay leg must be included, even if the team has not assigned any team member to the leg.
     *
     * @return \Petrocki\IofXmlPhp\TeamMemberStartType[]
     */
