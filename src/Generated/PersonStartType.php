...
class PersonStartType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\PersonRaceStartType[] $start
     */
    private $start = [
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\PersonRaceStartType $start
     */
    public function addToStart(\Petrocki\IofXmlPhp\PersonRaceStartType $start)
    {
        $this->start[] = $start;
        return $this;
    }
     ...
     * The core start information for the person; one element per race in the event.
     *
     * @return \Petrocki\IofXmlPhp\PersonRaceStartType[]
     */
