...
class PersonResultType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\PersonRaceResultType[] $result
     */
    private $result = [
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\PersonRaceResultType $result
     */
    public function addToResult(\Petrocki\IofXmlPhp\PersonRaceResultType $result)
    {
        $this->result[] = $result;
        return $this;
    }
     ...
     * The core result information for the person; one element per race in the event.
     *
     * @return \Petrocki\IofXmlPhp\PersonRaceResultType[]
     */
