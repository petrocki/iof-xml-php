...
class ClassStartType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\StartNameType[] $startName
     */
    private $startName = [
     ...
     *
     * @var \Petrocki\IofXmlPhp\PersonStartType[] $personStart
     */
    private $personStart = [
     ...
     *
     * @var \Petrocki\IofXmlPhp\TeamStartType[] $teamStart
     */
    private $teamStart = [
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\StartNameType $startName
     */
    public function addToStartName(\Petrocki\IofXmlPhp\StartNameType $startName)
    {
     ...
     * Defines the name of the start place (e.g. Start 1), if the race has multiple start places. One element per race.
     *
     * @return \Petrocki\IofXmlPhp\StartNameType[]
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\PersonStartType $personStart
     */
    public function addToPersonStart(\Petrocki\IofXmlPhp\PersonStartType $personStart)
    {
     ...
     * Start times for individual competitors in the class.
     *
     * @return \Petrocki\IofXmlPhp\PersonStartType[]
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\TeamStartType $teamStart
     */
    public function addToTeamStart(\Petrocki\IofXmlPhp\TeamStartType $teamStart)
    {
     ...
     * Start times for teams in the class.
     *
     * @return \Petrocki\IofXmlPhp\TeamStartType[]
     */
