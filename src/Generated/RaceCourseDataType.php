...
class RaceCourseDataType
{
     ...
     *
     * @var \Petrocki\IofXmlPhp\MapType[] $map
     */
    private $map = [
     ...
     *
     * @var \Petrocki\IofXmlPhp\ControlType[] $control
     */
    private $control = [
     ...
     *
     * @var \Petrocki\IofXmlPhp\CourseType[] $course
     */
    private $course = [
     ...
     *
     * @var \Petrocki\IofXmlPhp\ClassCourseAssignmentType[] $classCourseAssignment
     */
     ...
     *
     * @var \Petrocki\IofXmlPhp\PersonCourseAssignmentType[] $personCourseAssignment
     */
     ...
     *
     * @var \Petrocki\IofXmlPhp\TeamCourseAssignmentType[] $teamCourseAssignment
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\MapType $map
     */
    public function addToMap(\Petrocki\IofXmlPhp\MapType $map)
    {
        $this->map[] = $map;
        return $this;
    }
     ...
     * The map(s) used in this race. Usually just one map, but different courses may use different scales and/or areas.
     *
     * @return \Petrocki\IofXmlPhp\MapType[]
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\ControlType $control
     */
    public function addToControl(\Petrocki\IofXmlPhp\ControlType $control)
    {
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\CourseType $course
     */
    public function addToCourse(\Petrocki\IofXmlPhp\CourseType $course)
    {
        $this->course[] = $course;
        return $this;
    }
     ...
     * All courses of the race.
     *
     * @return \Petrocki\IofXmlPhp\CourseType[]
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\ClassCourseAssignmentType $classCourseAssignment
     */
    public function addToClassCourseAssignment(\Petrocki\IofXmlPhp\ClassCourseAssignmentType $classCourseAssignment)
    {
     ...
     * The assignment of courses to classes.
     *
     * @return \Petrocki\IofXmlPhp\ClassCourseAssignmentType[]
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\PersonCourseAssignmentType $personCourseAssignment
     */
    public function addToPersonCourseAssignment(\Petrocki\IofXmlPhp\PersonCourseAssignmentType $personCourseAssignment)
    {
     ...
     * The assignment of courses to individual competitors.
     *
     * @return \Petrocki\IofXmlPhp\PersonCourseAssignmentType[]
     */
     ...
     *
     * @return self
     * @param \Petrocki\IofXmlPhp\TeamCourseAssignmentType $teamCourseAssignment
     */
    public function addToTeamCourseAssignment(\Petrocki\IofXmlPhp\TeamCourseAssignmentType $teamCourseAssignment)
    {
     ...
     * The assignment of courses to relay team members teams.
     *
     * @return \Petrocki\IofXmlPhp\TeamCourseAssignmentType[]
     */
