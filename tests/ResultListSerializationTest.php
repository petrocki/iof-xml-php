...
class ResultListSerializationTest extends AbstractIofXmlTestCase
{
    ...
    {
        $original = $this->deserializer->deserializeresultList(file_get_contents(__DIR__.'/fixtures/ResultList1.xml'));
        $xml = $this->serializer->serializeResultList($original);

        $this->assertValidIofXml($xml);

        $reparsed = $this->deserializer->deserializeresultList($xml);
    ...
    {
        $original = $this->deserializer->deserializeresultList(file_get_contents(__DIR__.'/fixtures/ResultList2.xml'));
        $xml = $this->serializer->serializeResultList($original);
    ...
    {
        $original = $this->deserializer->deserializeresultList(file_get_contents(__DIR__.'/fixtures/ResultList3.xml'));
        $xml = $this->serializer->serializeResultList($original);
    ...
    {
        $original = $this->deserializer->deserializeresultList(file_get_contents(__DIR__.'/fixtures/ResultList4.xml'));
        $xml = $this->serializer->serializeResultList($original);
